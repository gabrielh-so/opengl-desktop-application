...
void Spotlight::AssignShaderValues(std::string uniformLocation, Shader &shader)
{
    ...
    shader.SetFloatVec3Uniform(uniformLocation + "direction", direction);
    shader.SetFloatUniform(uniformLocation + "cutoff", cutoff);
    shader.SetFloatUniform(uniformLocation + "outerCutoff", outerCutoff);
